...
class CCParser(Parser):
    ...
    @_('assignment_expression',
       #'expression "," expression %prec COMMA_OP',
       'expression "," assignment_expression %prec COMMA_OP'
       )
...
#    def initializer(self, p): pass
    ...
    @_('constant_init_expression',
       'constant_expression_list "," constant_init_expression'
       )
...
#       )
#    def initializer_list(self, p): pass

    @_('EXTERN', 'STATIC', 'AUTO', 'REG')
    def storage_class_specifier(self, p): pass

    @_('CHAR', 'INT', 'FLOAT', 'DOUBLE', 'struct_or_union_specifier')
